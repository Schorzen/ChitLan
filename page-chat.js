...
import { markPublicChatSeen } from './unread.js';
...
// Mark as seen on arrival, then every ~20s while this page stays open —
// keeps the unread badge on other pages accurate for however long someone
// actually spent reading, without writing on every single message.
markPublicChatSeen(user.uid);
setInterval(() => markPublicChatSeen(user.uid), 20000);
